# SYNONYMOUS MUTATION FULL RUN: ONE DISTRIBUTION OF SHAPE = 0.25
#===============================================================
...
s_range <- seq(0, 0.0001, by = 2e-6)  # set range and interval of selection coefficients for mutant
...
for (s_mean in s_range) {
  ...
  k <- 0.25  # shape parameter of gamma distribution
...
write_xlsx(dos_data,"synonymous_data_run.xlsx")
